...
export const translations = {
  ...
  th: {
    ...
    adventures: {
      ...
      trips: [
        {
          name: "Big Buddha & Temple Trail",
          description: "สัมผัสพุทธศาสนาอย่างใกล้ชิดและชมวิวเกาะ 360 องศาที่น่าทึ่ง",
          purpose: "ดื่มด่ำวัฒนธรรม ถ่ายรูป และจุดชมวิวที่น่าทึ่ง",
          transport: "มอเตอร์ไซค์ (แนะนำ) หรือแท็กซี่",
          dresscode: "ปิดขา - ห้ามสวมชุดว่ายน้ำหรือกระโปรง",
          stops: [
            {
              name: "Kata Beach View Point",
              time: "15 min",
              activity: "แวะดูวิวพาโนรามาและดื่มสมูทตี้มะม่วงเย็นฉ่ำ",
              tip: "เชื่อฉันสิ ขอบคุณฉันทีหลัง - สมูทตี้มะม่วงต้องลอง!",
              mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A"
            },
            {
              name: "Big Buddha",
              time: "60 min",
              activity: "เดินรอบพระใหญ่สูง 45 เมตรที่สวยงามพร้อมวิวเกาะ 360 องศา เห็นพระสงฆ์สวดมนต์และซึมซับบรรยากาศ",
              tip: "ถ้าไม่มีมอเตอร์ไซค์ เตรียมเดินขึ้นเขาสูงชันในอากาศอุ่น - แต่คุ้มค่ามาก! ถ้ามีมอเตอร์ไซค์ ขับขึ้นไปได้เลย",
              mapLink: "https://maps.app.goo.gl/s3tJzWLYywEbrAHY9"
            },
            {
              name: "Wat Chalong Temple",
              time: "40 min",
              activity: "วัดที่สำคัญที่สุดของภูเก็ต - การผจญภัยเล็กๆ ในตัวของมันเอง",
              tip: "เมื่อลงมาจากพระใหญ่ ให้สังเกตถนนในชนบทสีเขียว ถ้าขี่มอเตอร์ไซค์ คุณจะเห็นบรรยากาศ 'ท้องถิ่น' และบ้านเรือน - สวยงามมาก!",
              mapLink: "https://maps.app.goo.gl/BP1nq5mMzTqgSfNo8"
            },
            {
              name: "Back to Waree's",
              time: "",
              activity: "ใคร่ครวญว่าผู้คนแตกต่างและสวยงามอย่างไร",
              tip: "ไม่ว่าจะเชื่อศาสนาหรือไม่ พุทธศาสนาให้มุมมองที่น่าสนใจแตกต่างจากศาสนาอับราฮัม - เน้น 'ตัวฉัน' แบบไม่เห็นแก่ตัว มากกว่าตำแหน่งของคุณในชุมชน",
              mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6"
            }
          ]
        },
        {
          name: "\"Big\" Bike Tour",
          description: "ขี่มอเตอร์ไซค์ตัวใหญ่ชมเส้นทางชายฝั่งที่สวยงามของภูเก็ต",
          purpose: "ทัวร์มอเตอร์ไซค์ ชมวิวชายฝั่ง และสำรวจเกาะ",
          transport: "ต้องมีใบอนุญาตขับขี่มอเตอร์ไซค์แบบเต็ม",
          dresscode: "แนะนำให้สวมหมวกกันน็อคและอุปกรณ์ป้องกัน",
          stops: [
            {
              name: "Pick up Motorcycle",
              time: "30 min",
              activity: "เช่าจากศูนย์กลางเมืองภูเก็ต - มีร้านมากมายที่มีรุ่นใหม่ ฉันได้ Honda Rebel จากที่นี่!",
              tip: "คุณต้องมีใบขับขี่มอเตอร์ไซค์แบบเต็ม ไม่ใช่แค่สกู๊ตเตอร์เล็ก ตำรวจมักตรวจเช็คแถวกะตะ/กะรน ดังนั้นต้องถูกกฎหมาย!",
              mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6"
            },
            {
              name: "Karon Viewpoint",
              time: "20 min",
              activity: "แวะดูวิวพาโนรามาที่ดีที่สุดในภูเก็ต - เห็นสามอ่าวในช็อตเดียว",
              tip: "ตำรวจมักจัดจุดที่นี่ ดังนั้นให้แน่ใจว่าใบขับขี่และเอกสารรถของคุณครบถ้วน แต่คุ้มค่าที่จะแวะ!",
              mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A"
            },
            {
              name: "Phuket Big Bike",
              time: "10 min",
              activity: "ขับผ่าน (หรือหยุดถ้าคุณฝันใหญ่!) - โชว์รูม BMW ที่สร้างความฝัน",
              tip: "ฉันมักฝันกลางวันเกี่ยวกับการซื้อ BMW จอดไว้กับเพื่อนและกลับมาทุกปี... แล้วก็กลับสู่ความเป็นจริง! 😄",
              mapLink: "https://maps.app.goo.gl/ujzvhgkE3o5Q4DLP9"
            },
            {
              name: "Rawai Seafood Market",
              time: "60 min",
              activity: "พักกลางวัน! ถนนหาดราไวยอดเยี่ยม - มีทางเลือกมากมาย ไม่ใช่แค่อาหารทะเล",
              tip: "บรรยากาศถนนหาดที่นี่ไม่มีใครเทียบได้ ใช้เวลาเลือกจุด - มีตัวเลือกเยอะมาก",
              mapLink: "https://maps.app.goo.gl/AGShCoft56TojrsB7"
            },
            {
              name: "Promthep Cape",
              time: "30 min",
              activity: "ปลายใต้สุดของภูเก็ต - เดินชมและซึมซับวิว อาจจะแออัดในฤดูกาลท่องเที่ยว",
              tip: "แม้จะแออัด ก็คุ้มค่า การเดินขึ้นประภาคารและจุดชมวิวสวยงามมาก",
              mapLink: "https://maps.app.goo.gl/NMhgMLVjuBi8b8UVA"
            },
            {
              name: "Yanui Beach",
              time: "30 min",
              activity: "จุดพักผ่อนดื่มของผ่อนคลาย - เก็บการดื่มไว้จนมาถึงที่นี่ คุ้มค่ารอ",
              tip: "จุดผ่อนคลายที่สมบูรณ์แบบก่อนกลับ บรรยากาศชายหาดที่นี่สุดยอด",
              mapLink: "https://maps.app.goo.gl/3BMH5MAKcksauDXn9"
            },
            {
              name: "Back to Waree's",
              time: "",
              activity: "แค่ถนนคดเคี้ยว ต้นไม้เขียวชอุ่ม และปล่อยให้สมองดีท็อกซ์ นี่คือสิ่งที่การขี่มอเตอร์ไซค์ในไทยให้!",
              tip: "ข้อเท็จจริงสนุก: มีกลุ่มขี่มอเตอร์ไซค์ในพื้นที่ที่ทำทริปยาวไปกัวลาลัมเปอร์ กรุงเทพฯ และอื่นๆ ถ้าคุณชอบทัวริ่ง ค้นคว้าและเข้าร่วมกลุ่ม!",
              mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6"
            }
          ]
        },
        {
          ...
          purpose: "พักผ่อนริมชายหาด ว่ายน้ำ และบรรยากาศท้องถิ่น",
          dresscode: "นำชุดว่ายน้ำและครีมกันแดด",
          stops: [
            {
              name: "Kata Noi Beach",
              time: "90 min",
              activity: "เพื่อนบ้านเล็กๆ ของหาดกะตะ - หนึ่งในที่โปรดของฉัน! เล่นหมากรุกบนสนามหญ้า กินอาหารอร่อยๆ และว่ายไปมาตลอดทั้งวัน",
              tip: "คนน้อยกว่าหาดกะตะหลักแต่สวยพอๆ กัน หมากรุกบนสนามหญ้าเป็นจุดเด่นพิเศษที่หาไม่ได้ทุกที่!",
              mapLink: "https://maps.app.goo.gl/kjCYxSbXs7nyNoc56"
            },
            {
              name: "Nai Harn Beach",
              time: "90 min",
              activity: "ที่คนท้องถิ่นไป - สงบ สวยงาม และประสบการณ์ชายหาดภูเก็ตแท้ๆ",
              tip: "ถ้าเห็นคนท้องถิ่นที่นี่ คุณรู้ว่าเป็นจุดแท้จริง นี่คือที่เรามาพักผ่อนจริงๆ!",
              mapLink: "https://maps.app.goo.gl/nAKo36mCRay3ZCcf9"
            },
            {
              name: "Back to Waree's",
              time: "",
              activity: "อาบแดดและผ่อนคลาย - วันชายหาดที่สมบูรณ์แบบ",
              tip: "ชายหาดเหล่านี้อยู่ใกล้กะตะ/กะรน ไม่ต้องเดินทางไกลเพื่อบรรยากาศชายหาดที่เงียบสงบ",
              mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6"
            }
          ]
        },
  ...
  zh: {
    ...
    adventures: {
      ...
      trips: [
        {
          name: "Big Buddha & Temple Trail",
          description: "亲身体验佛教并欣赏令人惊叹的360度海岛全景",
          purpose: "文化沉浸、摄影和令人叹为观止的观景点",
          transport: "摩托车（推荐）或出租车",
          dresscode: "遮盖腿部 - 禁止穿泳衣或裙子",
          stops: [
            { name: "Kata Beach View Point", time: "15 min", activity: "停车欣赏全景并享用冰镇芒果冰沙", tip: "相信我，以后你会感谢我的 - 芒果冰沙必不可少！", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" },
            { name: "Big Buddha", time: "60 min", activity: "绕着令人惊叹的45米高雕像漫步，360度俯瞰全岛。观看僧侣祈祷，沉浸在氛围中", tip: "如果没有摩托车，准备在炎热天气中徒步爬上陡峭的山路 - 完全值得！有摩托车的话可以直接骑上去", mapLink: "https://maps.app.goo.gl/s3tJzWLYywEbrAHY9" },
            { name: "Wat Chalong Temple", time: "40 min", activity: "普吉岛最重要的寺庙 - 本身就是一次小冒险", tip: "从大佛下来时，注意绿色的乡村道路。骑摩托车的话，你会看到'当地'氛围和房屋 - 非常美丽！", mapLink: "https://maps.app.goo.gl/BP1nq5mMzTqgSfNo8" },
            { name: "Back to Waree's", time: "", activity: "反思人们的差异和美丽", tip: "无论是否信教，佛教提供了与亚伯拉罕宗教截然不同的视角 - 以非自私的方式关注'自我'，而不是你在社区中的位置", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }
          ]
        },
        {
          name: "\"Big\" Bike Tour",
          description: "在真正的摩托车上骑行普吉岛风景优美的海岸道路",
          purpose: "摩托车巡游、海岸风光和岛屿探索",
          transport: "需要完整摩托车驾照",
          dresscode: "推荐佩戴头盔和防护装备",
          stops: [
            { name: "Pick up Motorcycle", time: "30 min", activity: "从普吉镇中心租车 - 有很多店铺提供新车型。我在这里租到了我的Honda Rebel！", tip: "你需要完整的摩托车驾照，不仅仅是迷你踏板车驾照。警察经常在卡塔/卡伦附近检查，所以要合法！", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" },
            { name: "Karon Viewpoint", time: "20 min", activity: "停车欣赏普吉岛最好的全景 - 一次看三个海湾", tip: "警察经常在这里设卡，所以确保你的驾照和车辆文件齐全。不过值得停留！", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" },
            { name: "Phuket Big Bike", time: "10 min", activity: "路过（如果你梦想远大就停下！）- 实现梦想的BMW展厅", tip: "我总是白日梦想买一辆BMW，停在朋友那里，每年回来... 然后现实来了！😄", mapLink: "https://maps.app.goo.gl/ujzvhgkE3o5Q4DLP9" },
            { name: "Rawai Seafood Market", time: "60 min", activity: "午餐休息！拉威海滩路太棒了 - 选择很多，不仅仅是海鲜", tip: "这里的海滩路氛围无与伦比。慢慢选择一个地方 - 有几十个很棒的选择", mapLink: "https://maps.app.goo.gl/AGShCoft56TojrsB7" },
            { name: "Promthep Cape", time: "30 min", activity: "普吉岛最南端 - 四处走走欣赏风景。旺季可能会很拥挤", tip: "即使拥挤，也值得。灯塔步道和观景点令人惊叹", mapLink: "https://maps.app.goo.gl/NMhgMLVjuBi8b8UVA" },
            { name: "Yanui Beach", time: "30 min", activity: "放松喝点东西 - 把喝酒留到这里，绝对值得等待", tip: "返程前完美的放松地点。这里的海滩氛围完美", mapLink: "https://maps.app.goo.gl/3BMH5MAKcksauDXn9" },
            { name: "Back to Waree's", time: "", activity: "只有蜿蜒的道路、热带绿色植物和让大脑排毒。这就是泰国骑行的全部意义！", tip: "有趣的事实：该地区有骑行团体进行更长的旅行到吉隆坡、曼谷等地。如果你喜欢巡游，研究并加入一个团体！", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }
          ]
        },
        {
          name: "Hidden Beaches Hopper",
          description: "发现当地人喜爱的秘密景点，远离人群",
          purpose: "海滩放松、游泳和当地氛围",
          dresscode: "带泳衣和防晒霜",
          stops: [
            {
              name: "Kata Noi Beach",
              time: "90 min",
              activity: "卡塔海滩的小邻居 - 我个人最喜欢的之一！玩草坪国际象棋、吃美食、整天在沙滩上来回游泳",
              tip: "比主要的卡塔海滩人少，但同样美丽。草坪国际象棋是独特的亮点，不是到处都有！",
              mapLink: "https://maps.app.goo.gl/kjCYxSbXs7nyNoc56"
            },
            {
              name: "Nai Harn Beach",
              time: "90 min",
              activity: "当地人去的地方 - 宁静、美丽、正宗的普吉岛海滩体验",
              tip: "如果你看到当地人在这里，你就知道这是真正的好地方。这是我们真正来放松的地方！",
              mapLink: "https://maps.app.goo.gl/nAKo36mCRay3ZCcf9"
            },
            {
              name: "Back to Waree's",
              time: "",
              activity: "晒着太阳放松身心 - 完美的海滩日",
              tip: "这些海滩离卡塔/卡伦很近，无需长途跋涉就能享受宁静的海滩氛围",
              mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6"
            }
          ]
        },
        {
          ...
          stops: [
            ...
            { name: "Sunday Walking Street (Weekend Only)", time: "2 hrs", activity: "周日来访可浏览工艺品和街头表演", tip: "仅周日下午4点左右开始" }
          ]
        }
      ],
  ...
  ru: {
    ...
    adventures: {
      ...
      duration: "~2 часа",
      trips: [
        { name: "Big Buddha & Temple Trail", description: "Познайте буддизм воочию и насладитесь потрясающими видами на остров на 360°", purpose: "Культурное погружение, фотография и захватывающие смотровые площадки", transport: "Скутер (рекомендуется) или такси", dresscode: "Ноги закрыты - никаких купальников или юбок", stops: [
            { name: "Kata Beach View Point", time: "15 мин", activity: "Остановитесь для панорамных видов и возьмите ледяной манговый смузи", tip: "Поверьте, вы поблагодарите меня позже - манговый смузи обязателен!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" },
            { name: "Big Buddha", time: "60 мин", activity: "Прогуляйтесь вокруг потрясающей 45-метровой статуи с видом на остров на 360°. Увидьте молящихся монахов и насладитесь атмосферой", tip: "Без скутера будьте готовы подниматься по крутой дороге в жару - но это того стоит! Со скутером можно подъехать прямо наверх", mapLink: "https://maps.app.goo.gl/s3tJzWLYywEbrAHY9" },
            { name: "Wat Chalong Temple", time: "40 мин", activity: "Самый важный храм Пхукета - маленькое приключение само по себе", tip: "Спускаясь с Большого Будды, обратите внимание на зелёные сельские дороги. На скутере вы увидите 'местную' атмосферу и дома - это красиво!", mapLink: "https://maps.app.goo.gl/BP1nq5mMzTqgSfNo8" },
            { name: "Back to Waree's", time: "", activity: "Поразмышляйте о том, насколько разные и прекрасные люди", tip: "Религиозны вы или нет, буддизм предлагает захватывающий на 180° взгляд от авраамических религий - фокусируется на 'Я' несамолюбивым способом, а не на вашем месте в обществе", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }
          ]},
        { name: "\"Big\" Bike Tour", description: "Прокатитесь по живописным прибрежным дорогам Пхукета на настоящем мотоцикле", purpose: "Мотопутешествие, прибрежные виды и исследование острова", transport: "Требуются полные права на мотоцикл", dresscode: "Рекомендуется шлем и защитная экипировка", stops: [
            { name: "Pick up Motorcycle", time: "30 мин", activity: "Арендуйте в центре города Пхукет - множество магазинов с новыми моделями. Я получил здесь свой Honda Rebel!", tip: "Вам нужны ПОЛНЫЕ права на мотоцикл, а не только на мини-скутер. Полиция часто проверяет около Ката/Карона, так что будьте легальны!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" },
            { name: "Karon Viewpoint", time: "20 мин", activity: "Остановитесь для одних из лучших панорамных видов Пхукета - три залива в одном кадре", tip: "Полиция часто дежурит здесь, убедитесь, что ваши права и документы на мотоцикл в порядке. Но остановка того стоит!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" },
            { name: "Phuket Big Bike", time: "10 мин", activity: "Проезжайте мимо (или остановитесь, если мечтаете!) - шоурум BMW, где рождаются фантазии", tip: "Я всегда мечтаю о покупке BMW, оставить его у друга и возвращаться каждый год... потом реальность возвращает! 😄", mapLink: "https://maps.app.goo.gl/ujzvhgkE3o5Q4DLP9" },
            { name: "Rawai Seafood Market", time: "60 мин", activity: "Обеденный перерыв! Пляжная дорога Раваи потрясающая - столько выбора, не только морепродукты", tip: "Атмосфера пляжной дороги здесь непревзойденная. Не торопитесь выбирать место - есть десятки отличных вариантов", mapLink: "https://maps.app.goo.gl/AGShCoft56TojrsB7" },
            { name: "Promthep Cape", time: "30 мин", activity: "Южная оконечность Пхукета - прогуляйтесь и насладитесь видами. Может быть многолюдно в пиковый сезон", tip: "Даже если многолюдно, оно того стоит. Прогулка к маяку и смотровые площадки потрясающие", mapLink: "https://maps.app.goo.gl/NMhgMLVjuBi8b8UVA" },
            { name: "Yanui Beach", time: "30 мин", activity: "Расслабляющее место для напитков - приберегите выпивку до прибытия сюда, оно того стоит", tip: "Идеальное место для отдыха перед возвращением. Пляжная атмосфера здесь идеальна", mapLink: "https://maps.app.goo.gl/3BMH5MAKcksauDXn9" },
            { name: "Back to Waree's", time: "", activity: "Просто извилистые дороги, тропическая зелень и детокс мозга. Вот что такое езда на мотоцикле в Таиланде!", tip: "Интересный факт: В районе есть группы байкеров, совершающие длительные поездки в Куала-Лумпур, Бангкок и дальше. Если вы увлекаетесь туризмом, изучите и присоединяйтесь к группе!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }
          ]},
        { name: "Hidden Beaches Hopper", description: "Секретные места вдали от толпы", purpose: "Пляжный отдых, плавание и местная атмосфера", dresscode: "Возьмите купальники и солнцезащитный крем", stops: [
            { name: "Kata Noi Beach", time: "90 мин", activity: "Маленький сосед пляжа Ката - один из моих любимых! Играйте в шахматы на лужайке, ешьте вкусную еду и плавайте весь день", tip: "Меньше людей, чем на главном пляже Ката, но такой же красивый. Шахматы на лужайке - уникальная фишка!", mapLink: "https://maps.app.goo.gl/kjCYxSbXs7nyNoc56" },
            { name: "Nai Harn Beach", time: "90 мин", activity: "Куда ходят местные - спокойно, красиво и аутентичный пхукетский пляж", tip: "Если видите здесь местных, значит это настоящее место. Сюда мы приходим отдыхать по-настоящему!", mapLink: "https://maps.app.goo.gl/nAKo36mCRay3ZCcf9" },
            { name: "Back to Waree's", time: "", activity: "Загорелые и расслабленные - идеальный пляжный день", tip: "Эти пляжи близко к Ката/Карон, не нужна долгая поездка для спокойной пляжной атмосферы", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }
          ]},
        { name: "Old Town Food Walk", description: "Исторические улицы встречают вкусы Пхукета", purpose: "Уличная еда, архитектурные фото, культура", stops: [
            ...
            { name: "Sunday Walking Street (Weekend Only)", time: "2 hrs", activity: "Ремесла и уличные выступления по воскресеньям", tip: "Начинается около 16:00 только по воскресеньям" }
          ]}
      ],
  ...
  de: {
    ...
    adventures: {
      ...
      duration: "~2 Stunden",
      trips: [
        { name: "Big Buddha & Temple Trail", description: "Erleben Sie den Buddhismus hautnah und genießen Sie atemberaubende 360°-Inselblicke", purpose: "Kulturelles Eintauchen, Fotografie und atemberaubende Aussichtspunkte", transport: "Roller (empfohlen) oder Taxi", dresscode: "Beine bedeckt - keine Badeanzüge oder Röcke", stops: [{ name: "Kata Beach View Point", time: "15 Min", activity: "Halten Sie für Panoramablicke an und holen Sie sich einen eiskalten Mango-Smoothie", tip: "Glauben Sie mir, Sie werden mir später danken - der Mango-Smoothie ist unverzichtbar!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Big Buddha", time: "60 Min", activity: "Spazieren Sie um die beeindruckende 45-Meter-Statue mit 360°-Inselblick. Sehen Sie betende Mönche und genießen Sie die Atmosphäre", tip: "Ohne Roller seien Sie bereit, eine steile Straße bei warmen Temperaturen hochzuwandern - es lohnt sich total! Mit Roller können Sie direkt hochfahren", mapLink: "https://maps.app.goo.gl/s3tJzWLYywEbrAHY9" }, { name: "Wat Chalong Temple", time: "40 Min", activity: "Phukets wichtigster Tempel - ein kleines Abenteuer für sich", tip: "Auf dem Weg vom Big Buddha runter achten Sie auf die grünen ländlichen Straßen. Mit dem Roller sehen Sie die 'lokale' Atmosphäre und Häuser - es ist wunderschön!", mapLink: "https://maps.app.goo.gl/BP1nq5mMzTqgSfNo8" }, { name: "Back to Waree's", time: "", activity: "Reflektieren Sie, wie unterschiedlich und schön Menschen sein können", tip: "Ob religiös oder nicht, der Buddhismus bietet eine faszinierende 180°-Wendung von abrahamitischen Glaubensrichtungen - Fokus auf das 'Ich' auf nicht-selbstsüchtige Weise statt auf Ihren Platz in der Gemeinschaft", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "\"Big\" Bike Tour", description: "Fahren Sie Phukets malerische Küstenstraßen auf einem richtigen Motorrad", purpose: "Motorradtouren, Küstenansichten und Inselerkundung", transport: "Vollständiger Motorradführerschein erforderlich", dresscode: "Helm und Schutzkleidung empfohlen", stops: [{ name: "Pick up Motorcycle", time: "30 Min", activity: "Mieten Sie im Phuket Town Centre - viele Geschäfte mit neuen Modellen. Ich habe hier meine Honda Rebel bekommen!", tip: "Sie benötigen einen VOLLSTÄNDIGEN Motorradführerschein, nicht nur den Mini-Roller-Schein. Die Polizei kontrolliert oft rund um Kata/Karon, also seien Sie legal!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }, { name: "Karon Viewpoint", time: "20 Min", activity: "Halten Sie an für einige der besten Panoramablicke in Phuket - drei Buchten in einem Bild", tip: "Die Polizei richtet hier oft Kontrollpunkte ein, stellen Sie also sicher, dass Ihr Führerschein und die Fahrzeugpapiere in Ordnung sind. Die Pause lohnt sich aber!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Phuket Big Bike", time: "10 Min", activity: "Fahren Sie vorbei (oder halten Sie an, wenn Sie groß träumen!) - BMW-Showroom, wo Fantasien entstehen", tip: "Ich träume immer davon, eine BMW zu kaufen, sie bei einem Freund zu parken und jedes Jahr wiederzukommen... dann kommt die Realität! 😄", mapLink: "https://maps.app.goo.gl/ujzvhgkE3o5Q4DLP9" }, { name: "Rawai Seafood Market", time: "60 Min", activity: "Mittagspause! Rawai Strandstraße ist erstaunlich - so viel Auswahl, nicht nur Meeresfrüchte", tip: "Die Strandstraßen-Atmosphäre hier ist unschlagbar. Nehmen Sie sich Zeit, einen Platz zu wählen - es gibt Dutzende großartige Optionen", mapLink: "https://maps.app.goo.gl/AGShCoft56TojrsB7" }, { name: "Promthep Cape", time: "30 Min", activity: "Südspitze von Phuket - spazieren Sie herum und genießen Sie die Aussicht. Kann in der Hauptsaison voll werden", tip: "Auch wenn es voll ist, lohnt es sich. Der Leuchtturm-Spaziergang und die Aussichtspunkte sind atemberaubend", mapLink: "https://maps.app.goo.gl/NMhgMLVjuBi8b8UVA" }, { name: "Yanui Beach", time: "30 Min", activity: "Entspannter Trinkplatz - sparen Sie Ihr Trinken bis Sie hierher kommen, es lohnt sich total", tip: "Perfekter Ausklang-Platz vor der Rückfahrt. Die Strandatmosphäre ist hier perfekt", mapLink: "https://maps.app.goo.gl/3BMH5MAKcksauDXn9" }, { name: "Back to Waree's", time: "", activity: "Nur kurvige Straßen, tropisches Grün und Gehirn-Detox. Das ist es, worum es beim Motorradfahren in Thailand geht!", tip: "Fun Fact: Es gibt Motorradgruppen in der Gegend, die längere Touren nach Kuala Lumpur, Bangkok und darüber hinaus unternehmen. Wenn Sie auf Touren stehen, recherchieren Sie und schließen Sie sich einer Gruppe an!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Hidden Beaches Hopper", description: "Entdecken Sie geheime Orte", purpose: "Strandentspannung, Schwimmen und lokale Atmosphäre", dresscode: "Badeanzug und Sonnencreme mitbringen", stops: [{ name: "Kata Noi Beach", time: "90 Min", activity: "Der kleine Nachbar von Kata Beach - einer meiner Favoriten! Rasen-Schach spielen, tolles Essen und den ganzen Tag am Strand auf und ab schwimmen", tip: "Weniger überfüllt als der Haupt-Kata-Strand, aber genauso schön. Rasen-Schach ist eine einzigartige Note!", mapLink: "https://maps.app.goo.gl/kjCYxSbXs7nyNoc56" }, { name: "Nai Harn Beach", time: "90 Min", activity: "Wo die Einheimischen hingehen - friedlich, schön und authentisches Phuket-Stranderlebnis", tip: "Wenn Sie hier Einheimische sehen, wissen Sie, dass es echt ist. Hier kommen wir zum wirklichen Entspannen!", mapLink: "https://maps.app.goo.gl/nAKo36mCRay3ZCcf9" }, { name: "Back to Waree's", time: "", activity: "Sonnengeküsst und entspannt - der perfekte Strandtag", tip: "Diese Strände sind nah an Kata/Karon, keine lange Reise nötig für friedliche Strandatmosphäre", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Old Town Food Walk", description: "Historische Straßen treffen authentische Phuket-Aromen", purpose: "Street Food, Architekturfotografie, lokale Kultur", stops: [{ name: "Thalang Road", time: "30 Min", activity: "Farbenfrohe chinesisch-portugiesische Gebäude", tip: "Suchen Sie nach Street-Art-Wandgemälden" }, { name: "Kopitiam by Wilai", time: "25 Min", activity: "Traditionelles Phuket-Frühstück - Dim Sum & Kaffee", tip: "Hokkien-Nudeln probieren - lokale Spezialität" }, { name: "Local Markets", time: "35 Min", activity: "Roti, Satay und frische Früchte probieren", tip: "Sanft verhandeln und lächeln" }, { name: "Dessert at Torry's Ice Cream", time: "20 Min", activity: "Einzigartige Thai-inspirierte Eissorten", tip: "Kokosnussasche oder Thai-Tee - ein Muss" }, { name: "Sunday Walking Street (Weekend Only)", time: "2 hrs", activity: "Kunsthandwerk und Straßenaufführungen sonntags", tip: "Beginnt sonntags um 16 Uhr" }]}
      ],
  ...
  it: {
    ...
    adventures: {
      ...
      duration: "~2 ore",
      trips: [
        { name: "Big Buddha & Temple Trail", description: "Vivi il buddismo in prima persona e ammira viste mozzafiato a 360° sull'isola", purpose: "Immersione culturale, fotografia e punti panoramici mozzafiato", transport: "Scooter (consigliato) o taxi", dresscode: "Gambe coperte - no costumi da bagno o gonne", stops: [{ name: "Kata Beach View Point", time: "15 min", activity: "Fermati per viste panoramiche e prendi un frullato di mango ghiacciato", tip: "Credimi, mi ringrazierai dopo - il frullato di mango è essenziale!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Big Buddha", time: "60 min", activity: "Cammina attorno alla splendida statua di 45 metri con vista a 360° sull'isola. Vedi i monaci pregare e immergiti nell'atmosfera", tip: "Senza scooter, preparati a salire una strada ripida con temperature calde - ne vale totalmente la pena! Con lo scooter puoi salire direttamente", mapLink: "https://maps.app.goo.gl/s3tJzWLYywEbrAHY9" }, { name: "Wat Chalong Temple", time: "40 min", activity: "Il tempio più importante di Phuket - una piccola avventura di per sé", tip: "Scendendo dal Big Buddha, fai attenzione alle strade rurali verdi. Con lo scooter vedrai l'atmosfera 'locale' e le case - è bellissimo!", mapLink: "https://maps.app.goo.gl/BP1nq5mMzTqgSfNo8" }, { name: "Back to Waree's", time: "", activity: "Rifletti su quanto diverse e belle possano essere le persone", tip: "Che tu sia religioso o no, il buddismo offre un affascinante punto di vista a 180° dalle religioni abramitiche - si concentra sull''Io' in modo non egoistico piuttosto che sul tuo posto nella comunità", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "\"Big\" Bike Tour", description: "Percorri le strade costiere panoramiche di Phuket su una vera moto", purpose: "Tour in moto, viste costiere ed esplorazione dell'isola", transport: "Patente moto completa richiesta", dresscode: "Casco e attrezzatura protettiva consigliati", stops: [{ name: "Pick up Motorcycle", time: "30 min", activity: "Noleggia nel centro di Phuket Town - molti negozi con modelli nuovi. Ho preso la mia Honda Rebel qui!", tip: "Ti serve una patente moto COMPLETA, non solo quella per mini-scooter. La polizia controlla spesso intorno a Kata/Karon, quindi sii in regola!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }, { name: "Karon Viewpoint", time: "20 min", activity: "Fermati per alcune delle migliori viste panoramiche di Phuket - tre baie in uno scatto", tip: "La polizia spesso fa controlli qui, quindi assicurati che la tua patente e i documenti della moto siano in ordine. Vale comunque la fermata!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Phuket Big Bike", time: "10 min", activity: "Passa davanti (o fermati se sogni in grande!) - showroom BMW dove nascono le fantasie", tip: "Sogno sempre di comprare una BMW, parcheggiarla da un amico e tornare ogni anno... poi torna la realtà! 😄", mapLink: "https://maps.app.goo.gl/ujzvhgkE3o5Q4DLP9" }, { name: "Rawai Seafood Market", time: "60 min", activity: "Pausa pranzo! La strada della spiaggia di Rawai è fantastica - tante scelte, non solo frutti di mare", tip: "L'atmosfera della strada sulla spiaggia qui è imbattibile. Prenditi il tempo per scegliere un posto - ci sono dozzine di ottime opzioni", mapLink: "https://maps.app.goo.gl/AGShCoft56TojrsB7" }, { name: "Promthep Cape", time: "30 min", activity: "Punta sud di Phuket - passeggia e goditi le viste. Può essere affollato in alta stagione", tip: "Anche se affollato, ne vale la pena. La passeggiata al faro e i punti panoramici sono mozzafiato", mapLink: "https://maps.app.goo.gl/NMhgMLVjuBi8b8UVA" }, { name: "Yanui Beach", time: "30 min", activity: "Posto rilassante per un drink - risparmia il bere fino ad arrivare qui, vale totalmente l'attesa", tip: "Posto perfetto per rilassarsi prima di tornare. L'atmosfera della spiaggia qui è perfetta", mapLink: "https://maps.app.goo.gl/3BMH5MAKcksauDXn9" }, { name: "Back to Waree's", time: "", activity: "Solo strade tortuose, verde tropicale e detox del cervello. Questo è ciò di cui si tratta guidare moto in Thailandia!", tip: "Fatto curioso: Ci sono gruppi di motociclisti nella zona che fanno viaggi più lunghi a Kuala Lumpur, Bangkok e oltre. Se ti piace il touring, fai ricerche e unisciti a un gruppo!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Hidden Beaches Hopper", description: "Scoprire luoghi segreti lontano dalle folle", purpose: "Relax in spiaggia, nuoto e atmosfera locale", dresscode: "Portare costume da bagno e crema solare", stops: [{ name: "Kata Noi Beach", time: "90 min", activity: "Il piccolo vicino di Kata beach - uno dei miei preferiti! Gioca a scacchi sul prato, mangia ottimo cibo e fai vasche su e giù per la spiaggia tutto il giorno", tip: "Meno affollato della spiaggia principale di Kata ma altrettanto bello. Gli scacchi sul prato sono un tocco unico!", mapLink: "https://maps.app.goo.gl/kjCYxSbXs7nyNoc56" }, { name: "Nai Harn Beach", time: "90 min", activity: "Dove vanno i locali - tranquilla, bella e autentica esperienza di spiaggia a Phuket", tip: "Se vedi i locali qui, sai che è il posto giusto. Questo è dove veniamo a rilassarci davvero!", mapLink: "https://maps.app.goo.gl/nAKo36mCRay3ZCcf9" }, { name: "Back to Waree's", time: "", activity: "Baciati dal sole e rilassati - la perfetta giornata in spiaggia", tip: "Queste spiagge sono vicine a Kata/Karon, nessun lungo viaggio necessario per l'atmosfera tranquilla", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Old Town Food Walk", description: "Strade storiche incontrano i sapori autentici di Phuket", purpose: "Cibo di strada, fotografia architettonica, cultura locale", stops: [{ name: "Thalang Road", time: "30 min", activity: "Edifici sino-portoghesi colorati", tip: "Cercare i murales di street art" }, { name: "Kopitiam by Wilai", time: "25 min", activity: "Colazione tradizionale di Phuket - dim sum e caffè", tip: "Provare i noodles hokkien - specialità locale" }, { name: "Local Markets", time: "35 min", activity: "Assaggiare roti, satay e frutta fresca", tip: "Contrattare gentilmente e sorridere" }, { name: "Dessert at Torry's Ice Cream", time: "20 min", activity: "Gusti unici di gelato ispirati alla Thailandia", tip: "Cenere di cocco o tè tailandese da provare" }, { name: "Sunday Walking Street (Weekend Only)", time: "2 hrs", activity: "Artigianato e spettacoli di strada la domenica", tip: "Inizia intorno alle 16:00 solo la domenica" }]}
      ],
  ...
  sv: {
    ...
    adventures: {
      ...
      duration: "~2 timmar",
      trips: [
        { name: "Big Buddha & Temple Trail", description: "Upplev buddhismen på nära håll och njut av fantastiska 360° öutsikter", purpose: "Kulturell fördjupning, fotografering och hisnande utsiktspunkter", transport: "Skoter (rekommenderas) eller taxi", dresscode: "Täck benen - inga baddräkter eller kjolar", stops: [{ name: "Kata Beach View Point", time: "15 min", activity: "Stanna för panoramautsikter och ta en iskall mangosmoothie", tip: "Lita på mig, du kommer tacka mig senare - mangosmoothien är nödvändig!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Big Buddha", time: "60 min", activity: "Promenera runt den hisnande 45-metersstaty med 360° öutsikt. Se munkar be och njut av atmosfären", tip: "Utan skoter, var beredd på att vandra uppför en brant väg i varmt väder - helt värt det! Med skoter kan du köra rakt upp", mapLink: "https://maps.app.goo.gl/s3tJzWLYywEbrAHY9" }, { name: "Wat Chalong Temple", time: "40 min", activity: "Phukets viktigaste tempel - ett litet äventyr i sig", tip: "När du kommer ner från Big Buddha, lägg märke till de gröna lantliga vägarna. På skoter ser du den 'lokala' stämningen och husen - det är vackert!", mapLink: "https://maps.app.goo.gl/BP1nq5mMzTqgSfNo8" }, { name: "Back to Waree's", time: "", activity: "Reflektera över hur olika och vackra människor kan vara", tip: "Oavsett om du är religiös eller inte, erbjuder buddhismen en fascinerande 180° från abrahamitiska religioner - fokus på 'jaget' på ett icke-själviskt sätt snarare än din plats i samhället", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "\"Big\" Bike Tour", description: "Kör Phukets natursköna kustvägars på en riktig motorcykel", purpose: "Motorcykelturism, kustvyer och öutforskning", transport: "Fullständigt motorcykelkörkort krävs", dresscode: "Hjälm och skyddsutrustning rekommenderas", stops: [{ name: "Pick up Motorcycle", time: "30 min", activity: "Hyr i Phuket Town Centre - många butiker med nya modeller. Jag fick min Honda Rebel här!", tip: "Du behöver ett FULLSTÄNDIGT motorcykelkörkort, inte bara det för mini-skoter. Polisen kontrollerar ofta runt Kata/Karon, så var laglig!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }, { name: "Karon Viewpoint", time: "20 min", activity: "Stanna för några av de bästa panoramautsikterna på Phuket - tre vikar i ett foto", tip: "Polisen sätter ofta upp här, så se till att ditt körkort och cykelns papper är i ordning. Värt stoppet ändå!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Phuket Big Bike", time: "10 min", activity: "Kör förbi (eller stanna om du drömmer stort!) - BMW-showroom där fantasier skapas", tip: "Jag dagdrömmer alltid om att köpa en BMW, parkera den hos en vän och komma tillbaka varje år... sen kommer verkligheten! 😄", mapLink: "https://maps.app.goo.gl/ujzvhgkE3o5Q4DLP9" }, { name: "Rawai Seafood Market", time: "60 min", activity: "Lunchrast! Rawai strandväg är fantastisk - så mycket att välja på, inte bara skaldjur", tip: "Strandvägens atmosfär här är oslagbar. Ta dig tid att välja plats - det finns dussintals bra alternativ", mapLink: "https://maps.app.goo.gl/AGShCoft56TojrsB7" }, { name: "Promthep Cape", time: "30 min", activity: "Phukets sydspets - promenera runt och njut av vyerna. Kan bli trångt under högsäsong", tip: "Även om det är trångt är det värt det. Fyrvandringen och utsiktspunkterna är fantastiska", mapLink: "https://maps.app.goo.gl/NMhgMLVjuBi8b8UVA" }, { name: "Yanui Beach", time: "30 min", activity: "Avslappande dryckesplats - spara drickandet tills du kommer hit, det är helt värt väntan", tip: "Perfekt avkopplingsplats innan du åker tillbaka. Strandatmosfären här är perfekt", mapLink: "https://maps.app.goo.gl/3BMH5MAKcksauDXn9" }, { name: "Back to Waree's", time: "", activity: "Bara slingrande vägar, tropisk grönska och hjärnavgiftning. Det är det som motorcykelåkning i Thailand handlar om!", tip: "Rolig fakta: Det finns cykelgrupper i området som gör längre resor till Kuala Lumpur, Bangkok och bortom. Om du gillar touring, forska och gå med i en grupp!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Hidden Beaches Hopper", description: "Upptäck hemliga platser bort från folkmassorna", purpose: "Strandavkoppling, simning och lokal atmosfär", dresscode: "Ta med baddräkt och solskydd", stops: [{ name: "Kata Noi Beach", time: "90 min", activity: "Den lilla grannen till Kata beach - en av mina favoriter! Spela schack på gräsmattan, ät god mat och simma upp och ner längs stranden hela dagen", tip: "Mindre folkmassor än huvudstranden Kata men lika vacker. Schack på gräsmattan är en unik detalj!", mapLink: "https://maps.app.goo.gl/kjCYxSbXs7nyNoc56" }, { name: "Nai Harn Beach", time: "90 min", activity: "Där lokalbefolkningen går - fridfull, vacker och autentisk Phuket-strandupplevelse", tip: "Om du ser lokala här vet du att det är äkta. Hit kommer vi för att verkligen slappna av!", mapLink: "https://maps.app.goo.gl/nAKo36mCRay3ZCcf9" }, { name: "Back to Waree's", time: "", activity: "Solkyss och avslappnad - den perfekta stranddagen", tip: "Dessa stränder är nära Kata/Karon, ingen lång resa behövs för den fridfulla strandatmosfären", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Old Town Food Walk", description: "Historiska gator möter autentiska Phuket-smaker", purpose: "Gatumat, arkitekturfotografering, lokal kultur", stops: [{ name: "Thalang Road", time: "30 min", activity: "Färgglada kinesisk-portugisiska byggnader", tip: "Leta efter street art-muralmålningar" }, { name: "Kopitiam by Wilai", time: "25 min", activity: "Traditionell Phuket-frukost - dim sum & kaffe", tip: "Prova hokkien-nudlar - lokal specialitet" }, { name: "Local Markets", time: "35 min", activity: "Prova roti, satay och färsk frukt", tip: "Pruta försiktigt och le" }, { name: "Dessert at Torry's Ice Cream", time: "20 min", activity: "Unika thaiinspirerade glassmaker", tip: "Kokosaska eller thai-te är ett måste" }, { name: "Sunday Walking Street (Weekend Only)", time: "2 hrs", activity: "Bläddra hantverk och gatuföreställningar på söndagar", tip: "Börjar runt 16:00 endast söndagar" }]}
      ],
    ...
    adventures: {
      ...
      duration: "~2 tuntia",
      trips: [
        { name: "Big Buddha & Temple Trail", description: "Koe buddhalaisuus omakohtaisesti ja nauti upeistaista 360° saaren näkymistä", purpose: "Kulttuurinen uppoutuminen, valokuvaus ja henkeäsalpaavat näköalapaikat", transport: "Skootteri (suositellaan) tai taksi", dresscode: "Jalat peitetty - ei uimapukuja tai hameita", stops: [{ name: "Kata Beach View Point", time: "15 min", activity: "Pysähdy panoraamanäkymien ääreen ja ota jääkylmä mangosmoothie", tip: "Luota minuun, kiität minua myöhemmin - mangosmoothie on välttämätön!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Big Buddha", time: "60 min", activity: "Kävele upean 45-metrisen patsaan ympäri 360° saaren näkymillä. Näe munkkeja rukoilemassa ja nauti tunnelmasta", tip: "Ilman skooteria, ole valmis kiipeämään jyrkkää tietä lämpimissä lämpötiloissa - täysin sen arvoista! Skootterilla voit ajaa suoraan ylös", mapLink: "https://maps.app.goo.gl/s3tJzWLYywEbrAHY9" }, { name: "Wat Chalong Temple", time: "40 min", activity: "Phuketin tärkein temppeli - pieni seikkailu sinänsä", tip: "Tullessasi alas Big Buddhasta, kiinnitä huomiota vihreisiin maaseutumaisiin teihin. Skootterilla näet 'paikallisen' tunnelman ja talot - se on kaunista!", mapLink: "https://maps.app.goo.gl/BP1nq5mMzTqgSfNo8" }, { name: "Back to Waree's", time: "", activity: "Pohdiskele kuinka erilaisia ja kauniita ihmiset voivat olla", tip: "Olitpa uskonnollinen tai et, buddhalaisuus tarjoaa kiehtovan 180° käänteen abrahamilaisista uskonnoista - keskittyen 'minään' ei-itsekkäällä tavalla sen sijaan että keskittyisi asemaasi yhteisössä", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "\"Big\" Bike Tour", description: "Aja Phuketin luonnonkaunista rantatiellä oikealla moottoripyörällä", purpose: "Moottoripyörämatkailu, rannikon näkymät ja saaren tutkiminen", transport: "Täysi moottoripyöräajokortti vaaditaan", dresscode: "Kypärä ja suojavarusteet suositellaan", stops: [{ name: "Pick up Motorcycle", time: "30 min", activity: "Vuokraa Phuket Town Centrestä - monia liikkeitä uusilla malleilla. Sain Honda Rebellini täältä!", tip: "Tarvitset TÄYDEN moottoripyöräajokortin, ei vain mini-skootteriajokorttia. Poliisi tarkistaa usein Kata/Karon alueella, joten ole laillinen!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }, { name: "Karon Viewpoint", time: "20 min", activity: "Pysähdy joihinkin Phuketin parhaista panoraamanäkymistä - kolme lahtea yhdessä kuvassa", tip: "Poliisi perustaa usein tarkistuspisteitä tänne, joten varmista että ajokorttisi ja pyörän paperit ovat kunnossa. Pysähdys on silti sen arvoinen!", mapLink: "https://maps.app.goo.gl/EGhPrq7cFn4dKm27A" }, { name: "Phuket Big Bike", time: "10 min", activity: "Aja ohi (tai pysähdy jos haaveilet suuresti!) - BMW-näyttelyhalli missä fantasiat syntyvät", tip: "Haaveilen aina BMW:n ostamisesta, sen pysäköimisestä ystävän luokse ja paluusta joka vuosi... sitten todellisuus iskee! 😄", mapLink: "https://maps.app.goo.gl/ujzvhgkE3o5Q4DLP9" }, { name: "Rawai Seafood Market", time: "60 min", activity: "Lounasaika! Rawai rantatieli on upea - niin paljon vaihtoehtoja, ei vain merenelävät", tip: "Rantatien tunnelma täällä on lyömätön. Ota aikasi paikan valitsemiseen - on kymmeniä loistavia vaihtoehtoja", mapLink: "https://maps.app.goo.gl/AGShCoft56TojrsB7" }, { name: "Promthep Cape", time: "30 min", activity: "Phuketin eteläkärki - kävele ympäriinsä ja nauti näkymistä. Voi olla ruuhkaista sesonkiaikaan", tip: "Vaikka olisi ruuhkaista, se on sen arvoista. Majakanäkymä ja näköalapaikat ovat henkeäsalpaavia", mapLink: "https://maps.app.goo.gl/NMhgMLVjuBi8b8UVA" }, { name: "Yanui Beach", time: "30 min", activity: "Rentouttava juomapaikka - säästä juominen kunnes tulet tänne, se on täysin odotuksen arvoista", tip: "Täydellinen rentoutumispaikka ennen paluuta. Rannantunnelma täällä on täydellinen", mapLink: "https://maps.app.goo.gl/3BMH5MAKcksauDXn9" }, { name: "Back to Waree's", time: "", activity: "Vain mutkaiset tiet, trooppinen vehreys ja aivojen detoksaus. Tästä moottoripyöräilyssä Thaimaassa on kyse!", tip: "Hauska fakta: Alueella on moottoripyöräilyryhmiä jotka tekevät pidemmät matkat Kuala Lumpuriin, Bangkokiin ja kauemmas. Jos pidät matkailusta, tutki ja liity ryhmään!", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Hidden Beaches Hopper", description: "Löydä salaiset paikat kaukana väkijoukosta", purpose: "Rannan rentoutumista, uintia ja paikallista tunnelmaa", dresscode: "Ota uima-asu ja aurinkovoide mukaan", stops: [{ name: "Kata Noi Beach", time: "90 min", activity: "Kata beachin pieni naapuri - yksi suosikeistani! Pelaa ruohikko-shakkia, syö hyvää ruokaa ja ui rannalla ylös ja alas koko päivän", tip: "Vähemmän ruuhkaa kuin pää-Kata beach mutta yhtä kaunis. Ruohikko-shakki on ainutlaatuinen yksityiskohta!", mapLink: "https://maps.app.goo.gl/kjCYxSbXs7nyNoc56" }, { name: "Nai Harn Beach", time: "90 min", activity: "Missä paikalliset käyvät - rauhallinen, kaunis ja aito Phuketin rantakokemus", tip: "Jos näet paikallisia täällä, tiedät että se on aitoa. Tänne me tulemme todella rentoutumaan!", mapLink: "https://maps.app.goo.gl/nAKo36mCRay3ZCcf9" }, { name: "Back to Waree's", time: "", activity: "Auringon suutelema ja rentoutunut - täydellinen rantapäivä", tip: "Nämä rannat ovat lähellä Kataa/Karonia, ei tarvita pitkää matkaa rauhalliseen rantatunnelmaan", mapLink: "https://maps.app.goo.gl/NFova6qdwRZtQ97M6" }]},
        { name: "Old Town Food Walk", description: "Historialliset kadut kohtaavat aidot Phuket-maut", purpose: "Katumatua, arkkitehtuurivalokuvaus, paikallinen kulttuuri", stops: [{ name: "Thalang Road", time: "30 min", activity: "Värikkäät kiinalais-portugalilaiset rakennukset", tip: "Etsi katuteidemuuraalia" }, { name: "Kopitiam by Wilai", time: "25 min", activity: "Perinteinen Phuket-aamiainen - dim sum & kahvi", tip: "Maista hokkien-nuudeleita - paikallinen erikoisuus" }, { name: "Local Markets", time: "35 min", activity: "Maista rotia, satayta ja tuoreita hedelmiä", tip: "Tinkaa lempeästi ja hymyile" }, { name: "Dessert at Torry's Ice Cream", time: "20 min", activity: "Ainutlaatuiset thai-inspiroitut jäätelömaut", tip: "Kookostuhka tai thai-tee on pakko maistaa" }, { name: "Sunday Walking Street (Weekend Only)", time: "2 hrs", activity: "Selaa käsitöitä ja katuesiintymiä sunnuntaisin", tip: "Alkaa noin klo 16 vain sunnuntaisin" }]}
      ],
